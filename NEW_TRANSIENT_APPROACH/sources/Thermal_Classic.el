...
END PORT
/*-----------------------------------------------------------------------------------------
  COMPONENT Wall for 1D heat transfer in a wall using the Classical Approach 
-----------------------------------------------------------------------------------------*/ 
COMPONENT Wall_Classic (INTEGER nodes = 20 ) "Thermal 1D transient wall using the classical approach"
   PORTS
      IN thermal tp_in
      OUT thermal tp_out
   DATA
